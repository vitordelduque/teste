    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="w-full bg-wevets-blue text-white text-center text-xs md:text-sm flex items-center">
        <div className="max-w-6xl mx-auto flex items-center justify-center gap-2 px-4 w-full flex-wrap md:flex-nowrap py-2 md:py-3 leading-tight">
          ...
          <span className="font-ubuntu font-bold tracking-wide ml-1">
            Use o cupom
          </span>
          <span className="font-montserrat font-bold bg-white text-wevets-blue px-2 py-1 rounded ml-1">
            {coupon}
          </span>
          <Button
            className="ml-2 px-3 py-1 text-xs md:text-sm"
            onClick={copyCoupon}
          >
