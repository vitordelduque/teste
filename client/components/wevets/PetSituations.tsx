...
export function PetSituations() {
  const situations = [
    {
      image: "https://api.builder.io/api/v1/image/assets/TEMP/053cc998d28149d538e81f3784ce28ef405494c1?width=124",
      title: "Totó comeu seu fone de ouvido e agora precisa fazer uma cirurgia de urgência",
      withoutPlan: "R$ 0.000,00",
      withPlan: "R$ 000,00",
      description: "Considerando atendimento clínico geral, exames de imagem, hematológicos e cardiológicos, laparotomia e 48h de internação."
    },
    {
      image: "https://api.builder.io/api/v1/image/assets/TEMP/4ca45563b37bc0b051687be0318b4ff9ac05ecb1?width=124",
      title: "Lili parou de fazer xixi e agora precisa ser levada com urgência para análise",
      withoutPlan: "R$ 0.000,00",
      withPlan: "R$ 000,00",
      description: "Considerando atendimento clínico geral, exames de imagem, exames laboratoriais complexos, anestesia e procedimentos clínicos, 48h de internação e consulta com especialista."
    }
  ];
            ...
            <div className="space-y-2 mb-4">
              ...
              <div className="flex justify-between items-center">
                <span className="font-montserrat text-sm font-bold text-wevets-blue">
                  {index === 0 ? "Procedimento com WeVets Premium" : "Emergência com plano"}
                </span>
